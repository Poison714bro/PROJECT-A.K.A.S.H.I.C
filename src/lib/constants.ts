...
export const navItems: { id: ViewType; label: string; icon: React.ElementType; clearance: number }[] = [
  ...
  { id: "map", label: "Incident Map", icon: Map, clearance: 1 },
  { id: "evidence", label: "Evidence Graph", icon: GitBranch, clearance: 2 },
  { id: "timeline-reconstructor", label: "Timeline Reconstructor", icon: Activity, clearance: 2 },
  { id: "movement-tracker", label: "Movement Tracker", icon: Radar, clearance: 2 },
  { id: "investigations", label: "Investigations", icon: Users, clearance: 2 },
  { id: "entity-resolution", label: "Entity Resolution", icon: Search, clearance: 2 },
  { id: "scraper", label: "Ingestion / Scraper", icon: Globe, clearance: 1 },
];
